...
import com.scott.myclipboard.data.MaxReminderPreviewLineCount
import com.scott.myclipboard.data.MaxReminderWidgetFontSize
import com.scott.myclipboard.data.MinReminderPreviewLineCount
import com.scott.myclipboard.data.MinReminderWidgetFontSize
import com.scott.myclipboard.data.local.ReminderEntity
import com.scott.myclipboard.reminder.buildReminderAnnotatedString
...
fun ReminderScreen(
    ...
    onExportReminderBackup: () -> Unit,
    onImportReminderBackup: () -> Unit,
    ...
    if (uiState.isSettingsVisible) {
        ReminderSettingsDialog(
            ...
            onExportReminderBackup = onExportReminderBackup,
            onImportReminderBackup = onImportReminderBackup,
        )
    }
}
            ...
            Column(
                ...
                Column(verticalArrangement = Arrangement.spacedBy(2.dp)) {
                    Row(
                        ...
                        if (uiState.hasBackup) {
                            TextButton(onClick = { isRestoreConfirmationVisible = true }) {
                                Text(stringResource(R.string.reminder_backup_restore_short_action))
                            }
                        }
                    }
                    if (backupDateText != null) {
                        Text(
                            text = stringResource(R.string.reminder_backup_saved_at_label, backupDateText),
                    ...
                    Row(
                        ...
                        TextButton(
                            onClick = onExportReminderBackup,
                        ...
                        TextButton(
                            onClick = onImportReminderBackup,
                            modifier = Modifier.weight(1f),
                        ) {
