...
fun PlatformGameScreen(
    ...
    val tryAgainText = stringResource(com.soctt.myclipboard.R.string.game_try_again_status)
    val ouchText = stringResource(com.soctt.myclipboard.R.string.game_ouch_status)
    val clearText = stringResource(com.soctt.myclipboard.R.string.game_clear_status)
    ...
    Box(
        ...
        Surface(
            ...
            Column(
                ...
                Text(
                    text = stringResource(com.soctt.myclipboard.R.string.game_title),
                    color = Color.White,
                    fontWeight = FontWeight.Bold,
                    fontSize = 18.sp,
                )
                Text(
                    text = stringResource(com.soctt.myclipboard.R.string.game_score, score),
        ...
        Row(
            ...
            Column(horizontalAlignment = Alignment.End) {
                Button(
                    ...
                    Text(stringResource(com.soctt.myclipboard.R.string.game_reset_action))
                }
                ...
                Row(horizontalArrangement = Arrangement.spacedBy(10.dp)) {
                    ...
                    HoldActionButton(
                        label = if (isTransformed) "열선" else stringResource(com.soctt.myclipboard.R.string.game_tongue_action),
                        modifier = Modifier.size(width = 82.dp, height = 58.dp),
                    ...
                    HoldActionButton(
                        label = stringResource(com.soctt.myclipboard.R.string.game_jump_action),
                        modifier = Modifier.size(width = 82.dp, height = 58.dp),
